...
var MessengerConnectorInstance = (function () {
    ...
    MessengerConnectorInstance.prototype.sendImageMessage = function (recipientId, imgPath, fromServer) {
        if (fromServer === void 0) { fromServer = true; }
        console.log('FBBOT: sendImageMessage:', this.botConfig.serverURL + imgPath);
        var fullImgPath = (fromServer) ? this.botConfig.serverURL + imgPath : imgPath;
        var messageData = {
            recipient: {
                id: recipientId
            },
    ...
    MessengerConnectorInstance.prototype.sendQuickReply = function (recipientId, messageText, buttons) {
        if (!(buttons))
            throw "ERROR: Quick reply with no buttons!";
